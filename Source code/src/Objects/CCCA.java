...
public class CCCA extends CObject
{
    ...
    void startCCA(String filename, CObjectCommon ocPtr, boolean bInit, int nStartFrame)
    {
        ...
        {
         /*   if (hoAdRunHeader.rhApp.window != null)
            {
                Rectangle r = hoAdRunHeader.rhApp.window.getBounds();
                hoX += hoAdRunHeader.rhApp.insets.left + r.x;
                hoY += hoAdRunHeader.rhApp.insets.top + r.y;
            } */
        }
