...
public class CMovePlatform extends CMove
{
	...
	if (MP_Type==MPTYPE_WALK || MP_Type==MPTYPE_CROUCH || MP_Type==MPTYPE_UNCROUCH)
	{
            do
            {
                ...
                if (hoPtr.hoAdRunHeader.objectAllCol_IXY(hoPtr, hoPtr.roc.rcImage, hoPtr.roc.rcAngle, hoPtr.roc.rcScaleX, hoPtr.roc.rcScaleY, hoPtr.hoX, hoPtr.hoY)==null) 
                {
		    ArrayList<CObject> list=hoPtr.hoAdRunHeader.objectAllCol_IXY(hoPtr, hoPtr.roc.rcImage, hoPtr.roc.rcAngle, hoPtr.roc.rcScaleX, hoPtr.roc.rcScaleY, hoPtr.hoX, hoPtr.hoY+1);
