...
public class CFont
{
    ...
    public void load(CFile file)
    {
        ...
        lfItalic = (byte) file.readByte();
        lfUnderline = (byte) file.readByte();
        lfStrikeOut = (byte) file.readByte();
        file.readByte();
        file.readByte();
        file.readByte();
        file.readByte();
    ...
    public Typeface createFont()
    {
        if (font == null)
        {
            ...
            if (lfFaceName.compareToIgnoreCase("Arial") == 0)
            {
            	faceName=null;
            }
            int style=Typeface.NORMAL;
            if (lfItalic!=0 && lfWeight>=400)
            {
