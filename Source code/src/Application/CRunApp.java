...
//    public static final short ARF_PAUSEDBEFOREMODALLOOP=0x0008;
    ...
    public static final int AH2OPT_OPENGL20 = 0x10000;
    ...
    public void updateWindowDimensions(int width, int height)
    {
        ...
        int controlViewWidth = Math.round(gaCxWin * MMFRuntime.inst.scaleX);
        int controlViewHeight = Math.round(gaCyWin * MMFRuntime.inst.scaleY);
    ...
    public void setSurfaceEnabled (boolean enabled)
    {
        ...
        if (enabled)
        {
            ...
            surfaceView.setLayoutParams (new MainView.LayoutParams
                    (MainView.LayoutParams.FILL_PARENT, MainView.LayoutParams.FILL_PARENT,
                            0, 0));
    ...
    public boolean load(String ccnFilename)
    {
        ...
        try
        {
            if (ccnFilename == null)
            {
                file = new CFile (MMFRuntime.inst.getResourceID ("raw/application"), false);
                file.mmap ();
            }
            else
            {
        ...
        while (chk.chID != CChunk.CHUNK_LAST)
        {
            ...
            switch (chk.chID)
            {
                ...
                case 0x2223:
                    ...
                    loadAppHeader();
                    frameOffsets = new long[(int) gaNbFrames];
                    break;
                // CHUNK_APPNAME
                case 0x2224:
                ...
                case 0x224B:
                	...
                	for(int i = 0; i < androidMenu.length; ++ i)
                	{
...
*/        
    ...
    public void loadAppHeader2()
    {
        ...
        if (parentApp == null)
        {
            ...
            SurfaceView.ES2 = (hdr2Options & AH2OPT_OPENGL20) == 0;  /* NOTE: it's inverted! */
        }
    }
    ...
    public CEmbeddedFile getEmbeddedFile(String path)
    {
        ...
        if (embeddedFiles != null)
        {
            ...
            {
                if (embeddedFiles[n].path.compareToIgnoreCase(path) == 0)
                {
    ...
    public HFile openHFile(String path)
    {
    ...
    public void retrieveHFile(String path, final FileRetrievedHandler handler)
    {
        (new AsyncTask<String, Integer, Long>()
        {
            ...
            {
                final HFile file = openHFile(paths[0]);
