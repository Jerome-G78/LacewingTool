...
//                raAnimPreviousDir = -1;
        ...
        if (raAnimDir != dir)
        {
            ...
            if (adPtr == null)
            {
                ...
                else
                {
                    ...
                    if (raAnimPreviousDir >= 0)
                    {
                        ...
                        {
                            dir = raAnimPreviousDir;		// raAnimOffset.anTrigo[dir]&0x3F;
                        }
                    }
                }
                adPtr = raAnimOffset.anDirs[dir];
            ...
            if (raAnimDirOffset != adPtr)
            {
                ...
                if (raAnimStopped == false)
                {
                    ...
                    CImageInfo ifo = hoPtr.hoAdRunHeader.rhApp.imageBank.getImageInfoEx
                        (frame, hoPtr.roc.rcAngle, hoPtr.roc.rcScaleX, hoPtr.roc.rcScaleY);
        ...
        if (image!=hoPtr.roc.rcImage || raOldAngle!=hoPtr.roc.rcAngle)
        {
            ...
            CImageInfo ifo = hoPtr.hoAdRunHeader.rhApp.imageBank.getImageInfoEx
                (image, hoPtr.roc.rcAngle, hoPtr.roc.rcScaleX, hoPtr.roc.rcScaleY);
