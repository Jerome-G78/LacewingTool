...
public class CSprite 
{
    ...
    public static final int SF_PRIVATE=0x00000004;		// flag priv��� utilis��� par le yourapplication pour la destruction des fade
    ...
    public void updateBoundingBox()
    {
		...
		else
		{
		    ...
		    {
				double alpha = (double)sprAngle * Math.PI / 180.0;
    ...
    public void draw()
    {
        ...
        CImage ci=bank.getImageFromHandle(sprImg);
        ...
        GLRenderer.inst.renderScaledRotatedImage(ci, sprAngle, sprScaleX, sprScaleY,
                                                hsx, hsy, sprX, sprY,
                                                ci.getWidth (), ci.getHeight (),
                                                sprEffect, sprEffectParam);
    }
}
