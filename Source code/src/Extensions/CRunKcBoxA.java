...
//    int	ttY;
    ...
    public boolean createRunObject(CBinaryFile file, CCreateObjectInfo cob, int version)
    {
        ...
        this.rData.textColor = file.readInt();
        ...
        this.rData1.dwUnderlinedColor = file.readInt();
    ...
    public int handleRunObject()
    {
        ...
        int kMouse=rhPtr.rhApp.keyBuffer[CKeyConvert.VK_LBUTTON];
        if (kMouse!=oldKMouse)
        {
        	oldKMouse=kMouse;
        	if (kMouse!=0)
...
//        }
    ...
    public void displayRunObject()
    {
        ...
        rc.left = ho.hoRect.left;
        rc.top = ho.hoRect.top;
        rc.right = ho.hoRect.right;
        rc.bottom = ho.hoRect.bottom;
        // Check clipping
        ...
        if ((pText.length() != 0) && (pc.textColor != COLOR_NONE))
        {
			if(textNeedsRedraw)
        	{
	            ...
	            if ((pc.dwFlags & FLAG_DISABLED) != 0)
	            {
	                ...
	                textSurface.manualDrawText(pText, (short) dtFlags, rc, clr, font, false);
    ...
    {
        int clr = (int) this.rData.textColor;
        if ((clr & COLORFLAG_RGB) != 0)
        {
...
//	}
    ...
    {
        return new CValue((int)(21 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_3DFACE()
    {
        return new CValue((int)(15 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_3DHILIGHT()
    {
        return new CValue((int)(20 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_3DLIGHT()
    {
        return new CValue((int)(22 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_3DSHADOW()
    {
        return new CValue((int)(16 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_ACTIVEBORDER()
    {
        return new CValue((int)(10 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_ACTIVECAPTION()
    {
        return new CValue((int)(2 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_APPWORKSPACE()
    {
        return new CValue((int)(12 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_DESKTOP()
    {
        return new CValue((int)(1 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_BTNTEXT()
    {
        return new CValue((int)(18 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_CAPTIONTEXT()
    {
        return new CValue((int)(9 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_GRAYTEXT()
    {
        return new CValue((int)(17 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_HIGHLIGHT()
    {
        return new CValue((int)(13 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_HIGHLIGHTTEXT()
    {
        return new CValue((int)(14 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_INACTIVEBORDER()
    {
        return new CValue((int)(11 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_INACTIVECAPTION()
    {
        return new CValue((int)(3 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_INACTIVECAPTIONTEXT()
    {
        return new CValue((int)(19 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_INFOBK()
    {
        return new CValue((int)(24 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_INFOTEXT()
    {
        return new CValue((int)(23 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_MENU()
    {
        return new CValue((int)(4 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_MENUTEXT()
    {
        return new CValue((int)(7 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_SCROLLBAR()
    {
        return new CValue((int)(0 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_WINDOW()
    {
        return new CValue((int)(5 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_WINDOWFRAME()
    {
        return new CValue((int)(6 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
    private CValue ExpColor_WINDOWTEXT()
    {
        return new CValue((int)(8 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR));
    }
